...
| BEIR-style open retrieval runner | retrieval | implemented | WaveMind: nDCG@k 0.35, Recall@k 0.48, MRR@k 0.32, precision@1 0.24, avg latency 84.6, p95 latency 157.6<br>Chroma: nDCG@k 0.35, Recall@k 0.47, MRR@k 0.31, precision@1 0.24, avg latency 1.93, p95 latency 2.77<br>Qdrant: no checked-in result | Add Qdrant and sentence-transformers runs for SciFact, then add NFCorpus as the second BEIR dataset. |
| [LoCoMo evidence retrieval runner](https://github.com/snap-research/locomo) | long-term-conversation-memory | implemented | WaveMind: evidence recall@k 0.39, precision@1 0.24, MRR@k 0.31, context saved 0.00, avg latency 13.0, p95 latency 21.6<br>Static vector: evidence recall@k 0.20, precision@1 0.12, MRR@k 0.15, context saved 0.00, avg latency 13.6, p95 latency 16.8<br>Chroma static: evidence recall@k 0.19, precision@1 0.11, MRR@k 0.14, context saved 0.00, avg latency 1.93, p95 latency 2.79 | Run LoCoMo with sentence-transformers and add Qdrant static; then add answer generation with a local LLM. |
