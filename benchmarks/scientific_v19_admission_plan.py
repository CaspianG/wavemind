...
DEVELOPMENT = ROOT / "benchmarks" / "scientific_v19_development_outcome.json"
...
OUTPUT = ROOT / "benchmarks" / "scientific_v19_admission_plan.json"
DEVELOPMENT_OUTCOME_COMMIT = "96adaa9c02a6f9150b8d5da460259b142def8fed"
HARNESS_SOURCE_COMMIT = "3919543a92871ff19bc0def1f15ba683c9a0cd7d"
HARNESSES = (
    "benchmarks/scientific_mab_v19_final.py",
    "benchmarks/scientific_memops_v19_final.py",
    "benchmarks/scientific_longmemeval_v2_backend.py",
    "benchmarks/scientific_longmemeval_v2_backend_v19.py",
    "benchmarks/scientific_longmemeval_v2_run.py",
    "benchmarks/scientific_longmemeval_v2_run_v19.py",
)
...
def main() -> int:
    ...
    if development["status"] != "passed_development_gate_v19":
        raise RuntimeError("v19 development gate has not passed")
    ...
    payload = attach_artifact_integrity(
        {
            "schema": "wavemind.scientific_v19_admission_plan.v1",
            "status": "preregistered_before_first_v19_final_outcome",
            "preregistered_at": "2026-08-26",
            "candidate": {
                "id": "targeted-dual-coverage-agent-v19",
            ...
            "frozen_samples": {
                ...
                "memops": {
                    ...
                    "question_selection": "state-verification-v4",
                },
                "longmemeval_v2": {
            ...
            "decision_rule": (
                "Full v19 admission passes only when every frozen arm passes on the "
