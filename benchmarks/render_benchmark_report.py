...
METRIC_LABELS = {
    ...
    "encoder_contract_ok": "encoder contract",
    "encoder_contract_payloads": "encoder contract payloads",
    "encoder_contract_target_precision_at_1": "encoder target precision@1",
    "encoder_contract_global_precision_at_1": "encoder global precision@1",
    "encoder_contract_target_modality_routing_rate": "encoder routing",
    "encoder_contract_persisted_vector_rate": "encoder vectors persisted",
    "encoder_contract_normalized_vector_rate": "encoder vectors normalized",
    "encoder_contract_finite_vector_rate": "encoder vectors finite",
    "encoder_contract_provenance_rate": "encoder provenance",
    "encoder_contract_min_global_margin": "encoder min margin",
