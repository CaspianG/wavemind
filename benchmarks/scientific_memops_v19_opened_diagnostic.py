...
_SPEC = importlib.util.spec_from_file_location(
    "wavemind_scientific_memops_v19_opened_diagnostic_base",
    ROOT / "benchmarks" / "scientific_memops_v10_development.py",
)
if _SPEC is None or _SPEC.loader is None:
    raise RuntimeError("unable to load isolated v19 opened-diagnostic MemOps runner")
...
runner.CANDIDATE_ID_OVERRIDE = "targeted-dual-coverage-agent-v19-prototype"
runner.ARTIFACT_SCHEMA = "wavemind.scientific_memops_v19_opened_diagnostic.v1"
