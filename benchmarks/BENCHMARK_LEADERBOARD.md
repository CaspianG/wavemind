...
Last refresh: `2026-07-06T18:48:22Z` from `3e729f97c4a6`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.638 ms | - | WaveMind-only check |
