...
Last refresh: `2026-07-06T07:05:37Z` from `e2416483faa5`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.532 ms | - | WaveMind-only check |
