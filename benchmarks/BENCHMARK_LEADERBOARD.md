...
Last refresh: `2026-07-07T10:28:48Z` from `8531280c7bde`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.635 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T10:28:48Z` | source `8531280c7bde`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
