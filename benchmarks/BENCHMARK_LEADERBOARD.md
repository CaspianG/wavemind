...
Last refresh: `2026-07-09T06:55:17Z` from `e9e126053f60`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T06:55:17Z` | source `e9e126053f60`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
