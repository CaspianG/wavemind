...
Last refresh: `2026-07-09T14:18:25Z` from `901db1b0f562`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T14:18:25Z` | source `901db1b0f562`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
