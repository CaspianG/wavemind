...
Last refresh: `2026-07-07T09:56:28Z` from `cab60edc8ee3`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.845 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T09:56:28Z` | source `cab60edc8ee3`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
