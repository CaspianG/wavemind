...
Last refresh: `2026-07-07T23:46:18Z` from `72e26205801d`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.963 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T23:46:18Z` | source `72e26205801d`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
