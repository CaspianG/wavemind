...
Last refresh: `2026-07-07T16:55:46Z` from `b0795fff4c4d`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.911 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T16:55:46Z` | source `b0795fff4c4d`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
...
| Production readiness gate | checked-in benchmark artifacts | `pass`; 38/38 pass | Keep the gate at readiness_score 1.0 while repeating larger service-backed runs and moving external competitor evidence into the separate adapter profile. |
