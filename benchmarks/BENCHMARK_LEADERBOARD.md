...
Last refresh: `2026-07-08T17:26:32Z` from `80f588e1ee78`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.593 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-08T17:26:32Z` | source `80f588e1ee78`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
