...
Last refresh: `2026-07-08T15:23:39Z` from `db860186513a`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-08T15:23:39Z` | source `db860186513a`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
