...
Last refresh: `2026-07-06T16:14:25Z` from `2a42df8e2dfd`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 1.006 ms | - | WaveMind-only check |
