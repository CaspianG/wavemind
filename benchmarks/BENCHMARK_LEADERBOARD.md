...
Last refresh: `2026-07-09T23:59:37Z` from `b63923536682`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T23:59:37Z` | source `b63923536682`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
