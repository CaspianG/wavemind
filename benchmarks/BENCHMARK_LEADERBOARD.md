...
Last refresh: `2026-07-10T07:50:18Z` from `d88fa958082a`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-10T07:50:18Z` | source `d88fa958082a`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
