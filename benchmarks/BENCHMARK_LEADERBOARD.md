...
Last refresh: `2026-07-13T21:56:19Z` from `365c5ff4fbe1`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-13T21:56:19Z` | source `365c5ff4fbe1`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
