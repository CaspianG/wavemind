...
Last refresh: `2026-07-09T22:13:36Z` from `df73c3b56a63`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T22:13:36Z` | source `df73c3b56a63`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
