...
Last refresh: `2026-07-08T14:44:03Z` from `dfc070473493`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.762 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-08T14:44:03Z` | source `dfc070473493`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
