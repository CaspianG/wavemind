...
Last refresh: `2026-07-09T19:30:16Z` from `881594688fa0`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T19:30:16Z` | source `881594688fa0`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
