...
Last refresh: `2026-07-09T23:34:14Z` from `9956e3112dc5`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T23:34:14Z` | source `9956e3112dc5`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
