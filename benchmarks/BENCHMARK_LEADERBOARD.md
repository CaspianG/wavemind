...
Last refresh: `2026-07-10T06:49:30Z` from `b48e8f286570`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-10T06:49:30Z` | source `b48e8f286570`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
