...
Last refresh: `2026-07-08T05:14:25Z` from `5ae8f4785b1a`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-08T05:14:25Z` | source `5ae8f4785b1a`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
