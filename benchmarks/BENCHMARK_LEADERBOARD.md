...
Last refresh: `2026-07-10T07:22:05Z` from `c643d815177d`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-10T07:22:05Z` | source `c643d815177d`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
