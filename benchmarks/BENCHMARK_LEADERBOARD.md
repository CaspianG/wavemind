...
Last refresh: `2026-07-06T23:14:17Z` from `0009bda2c4fe`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.715 ms | - | WaveMind-only check |
| Production readiness gate | production-scale | readiness score | WaveMind production readiness: 0.967 / - | - | WaveMind-only check |
