...
Last refresh: `2026-07-07T11:33:07Z` from `1d5327d47b38`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.765 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T11:33:07Z` | source `1d5327d47b38`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
