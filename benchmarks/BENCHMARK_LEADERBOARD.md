...
Last refresh: `2026-07-09T21:07:48Z` from `9c9cfee3ed02`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.718 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T21:07:48Z` | source `9c9cfee3ed02`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
