...
Last refresh: `2026-07-06T11:54:49Z` from `da4ee366981a`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.659 ms | - | WaveMind-only check |
