...
Last refresh: `2026-07-06T06:02:08Z` from `a6086b48070a`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.531 ms | - | WaveMind-only check |
