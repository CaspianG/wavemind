...
Last refresh: `2026-07-09T06:00:26Z` from `6529912515c3`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T06:00:26Z` | source `6529912515c3`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
