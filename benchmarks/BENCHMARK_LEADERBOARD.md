...
Last refresh: `2026-07-12T18:39:45Z` from `a2e6a5ea1e63`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-12T18:39:45Z` | source `a2e6a5ea1e63`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
