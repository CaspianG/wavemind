...
Last refresh: `2026-07-06T23:31:40Z` from `38287cd0d133`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 1.782 ms | - | WaveMind-only check |
