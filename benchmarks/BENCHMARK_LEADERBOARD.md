...
Last refresh: `2026-07-12T19:58:26Z` from `0be7a3b918a1`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-12T19:58:26Z` | source `0be7a3b918a1`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
