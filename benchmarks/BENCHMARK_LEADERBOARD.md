...
Last refresh: `2026-07-06T08:58:50Z` from `71cccd3ebe4a`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.576 ms | - | WaveMind-only check |
