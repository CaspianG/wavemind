...
Last refresh: `2026-07-06T05:15:43Z` from `8cd98c0fa2d8`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.433 ms | - | WaveMind-only check |
