...
Last refresh: `2026-07-07T17:34:12Z` from `494693f0f6ab`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.866 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T17:34:12Z` | source `494693f0f6ab`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
