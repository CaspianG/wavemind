...
Last refresh: `2026-07-06T05:31:16Z` from `59b7834a141c`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.431 ms | - | WaveMind-only check |
