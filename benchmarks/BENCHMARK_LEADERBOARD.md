...
Last refresh: `2026-07-10T07:16:51Z` from `111326f28dd7`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-10T07:16:51Z` | source `111326f28dd7`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
