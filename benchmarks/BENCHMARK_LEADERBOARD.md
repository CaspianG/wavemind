...
Last refresh: `2026-07-07T13:48:12Z` from `ca450082244a`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T13:48:12Z` | source `ca450082244a`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
