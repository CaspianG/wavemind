...
Last refresh: `2026-07-09T03:59:20Z` from `d50bc070fb62`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-09T03:59:20Z` | source `d50bc070fb62`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
