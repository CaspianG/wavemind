...
Last refresh: `2026-07-05T23:07:33Z` from `d52f61923197`.
...
| Production load profile 1M | production-scale | Recall@k | - | Qdrant service: 0.984 / 116.8 ms | No WaveMind result; production SLO miss; cost if SLO fixed: Qdrant service $11.81/1M queries |
...
| Production readiness gate | production-scale | readiness score | WaveMind production readiness: 0.733 / - | - | WaveMind-only check |
