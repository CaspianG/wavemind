...
Last refresh: `2026-07-29T00:31:45Z` from `85f00b41f082`.
...
| [LongMemEval-V2](https://arxiv.org/abs/2605.12493) | web-agent-memory | task success | WaveMind Core: 0.1 / - | Legacy full execution: 0.091 / - | WaveMind leads on quality |

## Evidence Source Status

| area | current source | claim status | next action |
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-29T00:31:45Z` | source `85f00b41f082`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
