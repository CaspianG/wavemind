...
Last refresh: `2026-07-06T03:04:03Z` from `e33554abde9c`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.733 ms | - | WaveMind-only check |
| Production readiness gate | production-scale | readiness score | WaveMind production readiness: 0.938 / - | - | WaveMind-only check |
| Memory competitor adapter profile | agent-memory | precision@1 | WaveMind: 0.8 / 1.374 ms | LangGraph persistent memory: 0.8 / 1.746 ms | Quality tie; WaveMind faster |
