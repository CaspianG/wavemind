...
Last refresh: `2026-07-12T17:10:28Z` from `baa23bc9a969`.
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-12T17:10:28Z` | source `baa23bc9a969`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
