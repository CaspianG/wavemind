...
Last refresh: `2026-07-08T05:47:15Z` from `a2a8e78aabe1`.
...
| Agent coherence and token savings | agent-memory | task success | WaveMind: 0.917 / 2.49 ms | Static vector: 0.333 / 0.645 ms | WaveMind leads on quality |
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.61 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-08T05:47:15Z` | source `a2a8e78aabe1`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
