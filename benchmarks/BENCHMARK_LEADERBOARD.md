...
Last refresh: `2026-07-07T11:03:02Z` from `e4f2253d9fd6`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 1.024 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T11:03:02Z` | source `e4f2253d9fd6`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
