...
Last refresh: `2026-07-07T03:58:41Z` from `ad47ca1ded6b`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.742 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T03:58:41Z` | source `ad47ca1ded6b`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
