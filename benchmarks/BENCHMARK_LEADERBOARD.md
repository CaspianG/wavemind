...
Last refresh: `2026-07-07T13:14:48Z` from `d0d6b9d3253b`.
...
| Scale readiness profile | production-scale | precision@1 | WaveMind structured payloads: 1 / 0.627 ms | - | WaveMind-only check |
...
|---|---|---|---|
| Artifact freshness | local matrix refresh at `2026-07-07T13:14:48Z` | source `d0d6b9d3253b`; audit gate enforced by `validate_benchmark_artifacts.py` | Keep weekly refresh green before public claims. |
