...
def preflight(output_path: Path | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "environment": {
            ...
            "WAVEMIND_QDRANT_DEFER_INDEXING": os.environ.get("WAVEMIND_QDRANT_DEFER_INDEXING"),
            "WAVEMIND_QDRANT_DEFERRED_INDEXING_THRESHOLD_KB": os.environ.get("WAVEMIND_QDRANT_DEFERRED_INDEXING_THRESHOLD_KB"),
            "WAVEMIND_QDRANT_FINAL_INDEXING_THRESHOLD_KB": os.environ.get("WAVEMIND_QDRANT_FINAL_INDEXING_THRESHOLD_KB"),
