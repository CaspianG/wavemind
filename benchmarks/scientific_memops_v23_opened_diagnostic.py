...
_SPEC = importlib.util.spec_from_file_location(
    "wavemind_scientific_memops_v23_diagnostic_base",
    ROOT / "benchmarks" / "scientific_memops_v10_development.py",
)
if _SPEC is None or _SPEC.loader is None:
    raise RuntimeError("unable to load isolated v23 MemOps diagnostic runner")
...
runner.CANDIDATE_ID_OVERRIDE = "targeted-operation-application-agent-v23-prototype"
runner.ARTIFACT_SCHEMA = "wavemind.scientific_memops_v23_opened_diagnostic.v1"
