...
| `WAVEMIND_PGVECTOR_DSN` | `missing` | `postgres-dsn` | `pgvector_10m_service` | `production-streaming-load.yml` | `benchmarks/production_streaming_load_pgvector_10m_results.json` |
...
- `printf '%s' "$WAVEMIND_PGVECTOR_DSN" | gh secret set WAVEMIND_PGVECTOR_DSN --repo CaspianG/wavemind --body-file -`
