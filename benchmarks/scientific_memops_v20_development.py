...
_SPEC = importlib.util.spec_from_file_location(
    "wavemind_scientific_memops_v20_base",
    ROOT / "benchmarks" / "scientific_memops_v10_development.py",
)
if _SPEC is None or _SPEC.loader is None:
    raise RuntimeError("unable to load isolated v20 MemOps runner")
...
runner.CANDIDATE_ID_OVERRIDE = "operation-trace-dual-coverage-agent-v20"
runner.ARTIFACT_SCHEMA = "wavemind.scientific_memops_v20_development.v1"
