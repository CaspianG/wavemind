...
runner.CANDIDATE_ID_OVERRIDE = "target-scoped-state-verification-agent-v16-prototype3"
runner.ARTIFACT_SCHEMA = "wavemind.scientific_memops_v16_opened_diagnostic.v3"
