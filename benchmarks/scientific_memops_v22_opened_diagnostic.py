...
_SPEC = importlib.util.spec_from_file_location(
    "wavemind_scientific_memops_v22_diagnostic_base",
    ROOT / "benchmarks" / "scientific_memops_v10_development.py",
)
if _SPEC is None or _SPEC.loader is None:
    raise RuntimeError("unable to load isolated v22 MemOps diagnostic runner")
...
runner.CANDIDATE_ID_OVERRIDE = "query-grounded-targeted-discrimination-agent-v22-prototype"
runner.ARTIFACT_SCHEMA = "wavemind.scientific_memops_v22_opened_diagnostic.v1"
