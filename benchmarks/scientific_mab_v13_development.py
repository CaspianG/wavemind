...
_SPEC = importlib.util.spec_from_file_location(
    "wavemind_scientific_mab_v13_base",
    ROOT / "benchmarks" / "scientific_mab_v11_development.py",
)
if _SPEC is None or _SPEC.loader is None:
    raise RuntimeError("unable to load isolated v13 MAB runner")
runner = importlib.util.module_from_spec(_SPEC)
sys.modules[_SPEC.name] = runner
_SPEC.loader.exec_module(runner)

runner.PROTOCOL_PATH = ROOT / "benchmarks" / "scientific_memory_protocol_v13.json"
runner.ARTIFACT_SCHEMA = "wavemind.memoryagentbench_development.v13"
