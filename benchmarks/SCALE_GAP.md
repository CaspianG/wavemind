...
| complete profiles | `1/5` |
| ready to run | `0` |
| blocked by env | `4` |
| planned target memories | `180000000` |
| proven target memories | `50000000` |
