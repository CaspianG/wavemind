...
from benchmarks.local_http_active_active_smoke import (
    validate_external_active_active_payload,
)
...
def _external_cluster_requirement(root: Path) -> EvidenceRequirement:
    ...
    validation = validate_external_cluster_payload(payload or None)
...
def _external_active_active_requirement(root: Path) -> EvidenceRequirement:
    ...
    payload = _load_optional_json(root / artifact)
    validation = validate_external_active_active_payload(payload or None)
