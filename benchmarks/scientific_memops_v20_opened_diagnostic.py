...
_SPEC = importlib.util.spec_from_file_location(
    "wavemind_scientific_memops_v20_diagnostic_base",
    ROOT / "benchmarks" / "scientific_memops_v10_development.py",
)
if _SPEC is None or _SPEC.loader is None:
    raise RuntimeError("unable to load isolated v20 MemOps diagnostic runner")
runner = importlib.util.module_from_spec(_SPEC)
sys.modules[_SPEC.name] = runner
_SPEC.loader.exec_module(runner)

runner.PROTOCOL_PATH = ROOT / "benchmarks" / "scientific_memory_protocol_v19.json"
runner.CANDIDATE_MODE = ScientificCandidateMode.TARGET_SCOPED_OPERATION_AGENT
runner.CANDIDATE_ID_OVERRIDE = "operation-trace-dual-coverage-agent-v20-prototype"
runner.ARTIFACT_SCHEMA = "wavemind.scientific_memops_v20_opened_diagnostic.v1"
