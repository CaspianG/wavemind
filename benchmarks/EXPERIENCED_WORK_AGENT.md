...
|---|---:|---:|---:|---:|---:|
| Cold work agent | 0.0% | 100.0% | 4.0 | 0.0 | 28.96 ms |
| WaveMind Core | 16.7% | 83.3% | 4.0 | 60.0 | 37.00 ms |
| WaveMind Experience | 100.0% | 0.0% | 3.0 | 36.0 | 19.23 ms |

## Admission checks

- `pass` training-count: 60 (target: 60)
- `pass` held-out-count: 30 (target: 30)
- `pass` held-out-domain-balance: {'coding_repository': 10, 'support_crm': 10, 'enterprise_workflow': 10} (target: 10 per domain)
...
- `pass` p95-latency: -0.4802689904278913 (target: <= 0.20 relative)
