...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| WaveMind directional-head target | 2880 | 0.580 | 393.1 bps | 615.3 bps | 4.05% | 0.100 | 0.356 | 22.39% |
...
|---|---|---|---:|---:|---:|---:|---:|---:|
| WaveMind directional-head target | HYPE/USDT:USDT | 1h | 0 | 90 | 0.556 | 661.5 bps | 7.22% | 482.0 bps |
...
| WaveMind directional-head target | HYPE/USDT:USDT | 1h | 1 | 90 | 0.578 | 493.4 bps | 4.59% | -350.3 bps |
...
| WaveMind directional-head target | HYPE/USDT:USDT | 1h | 2 | 90 | 0.656 | 327.2 bps | 3.38% | 79.1 bps |
...
| WaveMind directional-head target | HYPE/USDT:USDT | 1h | 3 | 90 | 0.467 | 395.6 bps | 3.83% | -174.2 bps |
...
| WaveMind directional-head target | HYPE/USDT:USDT | 4h | 0 | 90 | 0.622 | 394.7 bps | 3.90% | -6.4 bps |
...
| WaveMind directional-head target | HYPE/USDT:USDT | 4h | 1 | 90 | 0.356 | 328.4 bps | 3.21% | -126.8 bps |
...
| WaveMind directional-head target | HYPE/USDT:USDT | 4h | 2 | 90 | 0.556 | 616.9 bps | 5.81% | -239.0 bps |
...
| WaveMind directional-head target | HYPE/USDT:USDT | 4h | 3 | 90 | 0.489 | 325.8 bps | 3.25% | 2.4 bps |
...
| WaveMind directional-head target | XRP/USDT:USDT | 1h | 0 | 90 | 0.911 | 231.6 bps | 2.42% | 149.8 bps |
...
| WaveMind directional-head target | XRP/USDT:USDT | 1h | 1 | 90 | 0.489 | 307.2 bps | 2.91% | -204.3 bps |
...
| WaveMind directional-head target | XRP/USDT:USDT | 1h | 2 | 90 | 0.856 | 163.5 bps | 1.69% | 139.6 bps |
...
| WaveMind directional-head target | XRP/USDT:USDT | 1h | 3 | 90 | 0.533 | 281.4 bps | 2.75% | -161.3 bps |
...
| WaveMind directional-head target | XRP/USDT:USDT | 4h | 0 | 90 | 0.411 | 296.4 bps | 2.96% | 17.4 bps |
...
| WaveMind directional-head target | XRP/USDT:USDT | 4h | 1 | 90 | 0.456 | 193.6 bps | 1.91% | -53.8 bps |
...
| WaveMind directional-head target | XRP/USDT:USDT | 4h | 2 | 90 | 0.522 | 161.0 bps | 1.62% | 54.1 bps |
...
| WaveMind directional-head target | XRP/USDT:USDT | 4h | 3 | 90 | 0.589 | 180.2 bps | 1.80% | -16.9 bps |
...
| WaveMind directional-head target | ZEC/USDT:USDT | 1h | 0 | 90 | 0.567 | 1708.3 bps | 22.39% | 807.4 bps |
...
| WaveMind directional-head target | ZEC/USDT:USDT | 1h | 1 | 90 | 0.489 | 784.3 bps | 7.02% | -456.8 bps |
...
| WaveMind directional-head target | ZEC/USDT:USDT | 1h | 2 | 90 | 0.656 | 306.5 bps | 3.20% | 92.5 bps |
...
| WaveMind directional-head target | ZEC/USDT:USDT | 1h | 3 | 90 | 0.767 | 324.8 bps | 3.08% | -216.3 bps |
...
| WaveMind directional-head target | ZEC/USDT:USDT | 4h | 0 | 90 | 0.467 | 465.5 bps | 4.75% | 113.3 bps |
...
| WaveMind directional-head target | ZEC/USDT:USDT | 4h | 1 | 90 | 0.511 | 523.1 bps | 4.75% | -264.3 bps |
...
| WaveMind directional-head target | ZEC/USDT:USDT | 4h | 2 | 90 | 0.556 | 529.6 bps | 5.25% | -39.9 bps |
...
| WaveMind directional-head target | ZEC/USDT:USDT | 4h | 3 | 90 | 0.533 | 342.3 bps | 3.43% | 28.9 bps |
...
| WaveMind directional-head target | SOL/USDT:USDT | 1h | 0 | 90 | 0.989 | 343.0 bps | 3.66% | 324.9 bps |
...
| WaveMind directional-head target | SOL/USDT:USDT | 1h | 1 | 90 | 0.667 | 293.5 bps | 2.78% | -204.7 bps |
...
| WaveMind directional-head target | SOL/USDT:USDT | 1h | 2 | 90 | 0.656 | 255.6 bps | 2.66% | 185.3 bps |
...
| WaveMind directional-head target | SOL/USDT:USDT | 1h | 3 | 90 | 0.744 | 191.0 bps | 1.87% | -33.6 bps |
...
| WaveMind directional-head target | SOL/USDT:USDT | 4h | 0 | 90 | 0.533 | 407.4 bps | 4.02% | -33.1 bps |
...
| WaveMind directional-head target | SOL/USDT:USDT | 4h | 1 | 90 | 0.356 | 261.5 bps | 2.60% | -47.0 bps |
...
| WaveMind directional-head target | SOL/USDT:USDT | 4h | 2 | 90 | 0.444 | 203.6 bps | 2.07% | 83.6 bps |
...
| WaveMind directional-head target | SOL/USDT:USDT | 4h | 3 | 90 | 0.567 | 279.7 bps | 2.74% | -118.1 bps |
