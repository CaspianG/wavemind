...
| 10M pgvector service load | `missing_artifact` | `ready_to_dispatch` | 10000000 | `benchmarks/production_streaming_load_pgvector_10m_results.json` | `` | 10M-100M service-backed production scale |
