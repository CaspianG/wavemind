...
_SPEC = importlib.util.spec_from_file_location(
    "wavemind_scientific_memops_v17_base",
    ROOT / "benchmarks" / "scientific_memops_v10_development.py",
)
if _SPEC is None or _SPEC.loader is None:
    raise RuntimeError("unable to load isolated v17 MemOps runner")
...
runner.CANDIDATE_ID_OVERRIDE = "safe-trajectory-state-agent-v17"
runner.ARTIFACT_SCHEMA = "wavemind.scientific_memops_v17_development.v1"
