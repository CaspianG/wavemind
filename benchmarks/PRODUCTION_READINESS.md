...
|---|---|---|---|
| Checked-in benchmark artifacts are synchronized | `pass` | audit status pass, generated_at 2026-07-07T01:15:38Z | Keep the benchmark refresh workflow green and block stale artifacts before release. |
