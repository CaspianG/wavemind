...
|---|---|---|---|
| Checked-in benchmark artifacts are synchronized | `pass` | audit status pass, generated_at 2026-07-06T21:43:12Z | Keep the benchmark refresh workflow green and block stale artifacts before release. |
