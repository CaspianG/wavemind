...
loopback evidence, not a real-cluster performance claim; the same contract
should be rerun against a real Knative/KEDA deployment before publishing
managed serverless numbers.
