...
const content = {
  en: {
    ...
    eyebrow: "Memory infrastructure for agents that learn with care",
    hero: <>Give every capable agent a memory <em>worth trusting.</em></>,
    lede: "WaveMind turns verified work into a small, inspectable experience the next agent run can use with confidence.",
    ...
    audience: { kicker: "THREE WAYS IN", title: <>One product thesis. <em>Three reasons to care.</em></>, body: "WaveMind is built for the people who need agents to improve with evidence — and for the people funding, operating and building that future.", roles: [["INVESTOR", "See the investment thesis", "A category wedge around responsible agent learning, not another vector store.", "Read the thesis"], ["DESIGN PARTNER", "Run a 30-day proof cycle", "Choose a repeatable workflow, define the outcome and inspect what the agent learns.", "See the pilot"], ["BUILDER", "Run the five-minute demo", "Follow one verified experience from failed run to cited next-run context.", "Run the demo"]] },
    ...
    cases: {
      ...
      items: [["Coding agents", "Carry validated fixes and environment-specific procedures between runs."], ["Support teams", "Remember corrections without bringing stale policy into the next customer conversation."], ["Operations agents", "Turn successful tool runs into auditable, scoped routines before reuse."]],
    },
    roadmap: { kicker: "06 / THE BUILD", title: <>A practical route to the <em>experience control plane.</em></>, body: "The plan is simple: demonstrate better work first, then make that evidence useful to every team running agents.", years: ["2026", "2027", "2027+"], items: [["Prove the loop", "Independent workflow benchmarks, clean claim gates, a TypeScript SDK and better first-run stories."], ["Make it inspectable", "A memory debugger that shows why a packet appeared, what it changed and what it saved."], ["Govern at scale", "Hosted collaboration, policy-as-code, deletion proofs and an open Experience Packet standard."]] },
  ...
  ru: {
    ...
    eyebrow: "Инфраструктура памяти для агентов, которые учатся осмысленно",
    hero: <>Дайте каждому сильному агенту память, <em>которой можно доверять.</em></>,
    lede: "WaveMind превращает проверенную работу в небольшой, прозрачный опыт, который следующий запуск агента использует уверенно.",
    ...
    audience: { kicker: "ТРИ ПУТИ ВНУТРЬ", title: <>Один продуктовый тезис. <em>Три причины не пройти мимо.</em></>, body: "WaveMind создан для тех, кому важно, чтобы агенты улучшались на доказательствах — и для тех, кто финансирует, запускает и строит это будущее.", roles: [["ИНВЕСТОР", "Увидеть инвестиционный тезис", "Категориальный wedge вокруг ответственного обучения агентов, а не ещё один vector store.", "Прочитать тезис"], ["DESIGN PARTNER", "Провести 30-дневный proof cycle", "Выберите повторяемый workflow, определите outcome и посмотрите, чему агент действительно учится.", "Посмотреть pilot"], ["РАЗРАБОТЧИК", "Запустить демо за пять минут", "Пройдите один verified experience: от failed run до cited context для следующего запуска.", "Запустить демо"]] },
    ...
    roadmap: { kicker: "06 / СОЗДАЁМ", title: <>Практический путь к <em>control plane опыта.</em></>, body: "План прост: сначала показать лучшую работу, затем сделать эти доказательства полезными для каждой команды, которая запускает агентов.", years: ["2026", "2027", "2027+"], items: [["Доказать цикл", "Независимые workflow benchmarks, чистые claim gates, TypeScript SDK и сильный first-run опыт."], ["Сделать опыт прозрачным", "Memory debugger, который показывает, почему появился пакет, что он изменил и что сэкономил."], ["Управлять на масштабе", "Совместная работа в hosted-версии, policy-as-code, deletion proofs и открытый стандарт Experience Packet."]] },
